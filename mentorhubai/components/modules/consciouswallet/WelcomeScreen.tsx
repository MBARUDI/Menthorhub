...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart }) => {
  ...
  return (
    <div className="w-full h-full overflow-y-auto bg-slate-900 flex items-start sm:items-center justify-center p-4 sm:p-8 custom-scrollbar">
      <div className="max-w-5xl w-full bg-white rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row my-auto">
