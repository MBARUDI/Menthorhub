...
export const SpeechInput: React.FC<SpeechInputProps> = ({
  ...
  const baseClasses = `w-full border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900 placeholder:text-gray-400 transition-all disabled:opacity-100 disabled:bg-gray-50 disabled:text-gray-900 ${className}`;
