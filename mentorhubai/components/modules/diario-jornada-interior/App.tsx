...
export default function App() {
  ...
  if (showIntro) {
    return (
      <div className="h-full overflow-y-auto bg-gradient-to-br from-blue-50 to-gray-100 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-2xl text-center border border-white/50">
          ...
          <h1 className="text-3xl font-serif font-bold text-blue-900 mb-2">Diário Jornada Interior</h1>
          ...
          <div className="mb-6 text-left">
            <label className="block text-blue-800 font-serif font-semibold mb-2 flex items-center gap-2">
              <User size={18} />
          ...
          <button 
            ...
            className="w-full bg-blue-600 text-white font-bold py-4 rounded-xl hover:bg-blue-700 transition-all shadow-lg hover:shadow-blue-500/30 transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        return (
          ...
          >
            <div className="space-y-8">
              <SpeechInput
                label={
                  <label className="block text-blue-800 font-serif font-semibold flex items-center gap-2">
      ...
      case Step.PLANNING:
        return (
          ...
          >
            <div className="space-y-6">
              <div>
                <label className="block text-blue-800 font-serif font-semibold mb-4 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {entry.tomorrowActions.map((action, index) => (
                    <div key={index} className="relative">
                      <span className="absolute left-3 top-3.5 text-gray-400 font-bold text-sm z-10">#{index + 1}</span>
                      <SpeechInput
                        value={action}
              ...
              <div className="pt-6 border-t border-gray-200">
                <label className="block text-blue-800 font-serif font-semibold mb-3">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  />
                  <span className="text-2xl font-bold text-blue-600 min-w-[2ch] text-center">{entry.productivityScore}</span>
                </div>
                <SpeechInput
          ...
          >
            <div className="space-y-6">
               <div className="text-center mb-6">
                 ...
                 <p className="text-gray-600">Agradeça por 3 bênçãos, fatos ou emoções do dia.</p>
               </div>
      ...
      case Step.FORGIVENESS:
        return (
          ...
          >
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-serif font-bold text-blue-800 mb-3 flex items-center gap-2">
                  <Leaf size={18} className="text-emerald-600" />
                  Exercício de Perdão
                </h3>
                <p className="text-sm text-gray-500 mb-3 italic">Complete mentalmente ou escreva: "Eu me perdoo por...", "Eu perdoo [nome] por..."</p>
                <div className="grid gap-4">
                   <SpeechInput
                    ...
                    isTextArea={true}
                    className="border-gray-200 focus:ring-emerald-400 bg-emerald-50/30 text-sm !h-24"
                  />
                   <SpeechInput
          ...
          <div className="max-w-2xl mx-auto w-full pb-10">
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8 border border-gray-200">
               <div className="bg-blue-900 p-8 text-center text-white relative overflow-hidden">
                 ...
                 <p className="text-blue-200 mt-2 relative z-10">{entry.date}</p>
                 <p className="text-blue-100 text-sm relative z-10 mt-1">Autor: {entry.userName}</p>
               </div>
               ...
               <div className="p-8 space-y-6">
                 ...
                 <div className="prose prose-stone max-w-none">
                   <h4 className="font-bold text-gray-800 border-b border-gray-200 pb-2">Destaques do Dia</h4>
                   <p className="text-gray-600 mt-2"><strong className="text-gray-900">Brilho:</strong> {entry.positiveHighlight}</p>
                   <p className="text-gray-600"><strong className="text-gray-900">Semente:</strong> {entry.contributionIdea}</p>
                   
                   <h4 className="font-bold text-gray-800 border-b border-gray-200 pb-2 mt-6">Compromissos para Amanhã</h4>
                   ...
                   <h4 className="font-bold text-gray-800 border-b border-gray-200 pb-2 mt-6">Gratidão</h4>
                   <ul className="list-disc pl-5 mt-2 space-y-1">
                     {entry.gratitudeList.filter(g => g).map((gratitude, i) => (
                       <li key={i} className="text-gray-600">{gratitude}</li>
                     ))}
                   </ul>
                 </div>
               </div>

               <div className="bg-gray-50 p-6 text-center border-t border-gray-200 flex flex-col md:flex-row justify-center gap-4">
                 <button 
                   onClick={generatePDF}
                   disabled={aiFeedback.loading}
                   className={`flex items-center justify-center gap-2 bg-blue-600 text-white font-bold px-6 py-3 rounded-xl transition-all shadow-lg transform ${aiFeedback.loading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700 hover:shadow-xl hover:-translate-y-0.5'}`}
                 >
                   <Printer size={20} />
                 ...
                 <button 
                  ...
                  className="px-6 py-3 rounded-xl text-blue-600 hover:text-blue-800 hover:bg-blue-50 transition-colors font-medium"
                 >
                   Novo Diário
                 </button>
               </div>
  ...
  return (
    <div className="h-full overflow-y-auto bg-gray-100 text-gray-800 font-sans selection:bg-blue-200 selection:text-blue-900 pb-12">
      {/* Header */}
      <header className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-serif font-bold text-gray-800 hidden sm:block">Jornada Interior</h1>
          </div>
          <div className="flex items-center gap-3">
             {entry.userName && <span className="text-sm font-medium text-blue-800 hidden md:block">Olá, {entry.userName.split(' ')[0]}</span>}
