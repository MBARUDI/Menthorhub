...
import FiveQs from './components/FiveQs';
import AIAdvisor from './components/AIAdvisor';
import FinancialDashboard from './components/FinancialDashboard';
import DreamsGoals from './components/DreamsGoals';
          ...
          <nav className="flex gap-1">
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 whitespace-nowrap ${
                activeTab === Tab.MATRIX ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-100'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 whitespace-nowrap ${
                activeTab === Tab.FIVE_QS ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-100'
              }`}
            >
              <PenTool size={18} />
             ...
             <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 whitespace-nowrap ${
                activeTab === Tab.ADVISOR ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-100'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 whitespace-nowrap ${
                activeTab === Tab.DASHBOARD ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-100'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 whitespace-nowrap ${
                activeTab === Tab.DREAMS ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-100'
              }`}
            >
              <Rocket size={18} />
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 whitespace-nowrap ${
                activeTab === Tab.WORK ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-100'
              }`}
            >
              <Briefcase size={18} />
