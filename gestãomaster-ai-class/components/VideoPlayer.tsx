...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ youtubeId, title }) => {
  ...
  // Safe fallback for origin to prevent hydration mismatch or invalid URLs
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* Botão de fallback caso o vídeo tenha restrições de embed (Erro 153 inevitável por parte do dono) */}
      <div className="flex items-center justify-between px-2">
        <div className="flex items-center gap-2 text-xs text-slate-500">
          <AlertCircle size={14} />
          <span>Se o vídeo não carregar (Erro 153), use o link direto.</span>
        </div>
        <a 
