...
import { Sparkles, BookOpen, Lightbulb, Loader2, GraduationCap, FileText, ChevronRight, ChevronLeft, PlayCircle } from 'lucide-react';
                ...
                {status === LoadingState.SUCCESS && content && (
                    <div className="space-y-6 animate-fadeIn pb-6">
                        <div className="bg-indigo-50/50 rounded-lg p-5 border border-indigo-100">
                            ...
                            <p className="text-slate-700 leading-relaxed text-sm md:text-base line-clamp-5">
                            {content.summary}
                            </p>
                        </div>
