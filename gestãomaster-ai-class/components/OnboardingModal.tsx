...
const OnboardingModal: React.FC<OnboardingModalProps> = ({ onComplete, isLoading }) => {
  ...
  // Cores para avatares (reutilizando lógica visual simples)
  ...
  // Filtra usuários baseado no input
        ...
        <div className="flex-1 overflow-y-auto px-6 py-2 space-y-2 min-h-[150px]">
            {isLoadingList ? (
                ...
                <>
                    ...
                    {/* Botão de Criar Novo (Se não houver match exato ou sempre visível se tiver texto) */}
