...
const VideosSstModule: React.FC = () => {
  const [activeVideo, setActiveVideo] = useState<Video | null>(null);

  const videos: Video[] = [
    { id: 'zrhQfs8jMI0', title: 'Introdução à Segurança do Trabalho' },
  ];
  ...
  return (
    <div className="flex flex-col h-full bg-gray-900 text-white overflow-hidden">
      ...
      <div className="p-4 border-b border-gray-800 bg-gray-900 shrink-0 flex items-center gap-2">
        ...
        <div>
          <h2 className="text-lg font-bold leading-tight">Vídeos SST</h2>
          <p className="text-xs text-gray-400">Treinamentos e Segurança</p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {videos.map((video) => (
            ...
            >
              <div className="relative w-full aspect-video rounded-lg overflow-hidden bg-gray-800 mb-2 shadow-lg border border-gray-700 group-hover:border-orange-500/50 transition-all">
                <img 
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/30">
                  <div className="bg-orange-500/90 rounded-full p-2 shadow-lg transform scale-75 group-hover:scale-100 transition-transform">
...
export default VideosSstModule;