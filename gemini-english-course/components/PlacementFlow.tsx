    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4 relative">
        ...
        <div className="max-w-3xl w-full p-4 text-center">
          <h1 className="text-[2.25rem] font-black text-slate-800 mb-3 tracking-tight">Bem-vindo, {userName}!</h1>
          <p className="text-slate-500 mb-10 text-[1.15rem] font-light">Para começar, qual língua você quer aprender hoje?</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {(['English', 'Spanish', 'Italian'] as TargetLanguage[]).map((lang) => (
              <button
                ...
                className="group relative p-10 bg-slate-50/50 border border-slate-200 rounded-xl hover:border-slate-300 hover:bg-slate-50 transition-all flex flex-col items-center gap-6"
              >
                ...
                <span className="font-bold text-slate-800 text-[1.1rem]">
